<div id="sendMsgPage" class="weui_msg">
    ...
    <div class="weui_cells weui_cells_form">
        <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
                <input id="addressInSendMsgPage" class="weui_input" type="text" value="<?php echo $intro;?>" disabled="true">
    ...
    <div class="weui_opr_area">
        <p class="weui_btn_area">
            <a href="<?php echo SITE_ROOT ?>" class="weui_btn weui_btn_default">返回首页</a>
        </p>
    </div>
</div>