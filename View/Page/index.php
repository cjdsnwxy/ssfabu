<div id="indexPage"  class="weui_msg">
  <div class="weui_icon_area">
    <img src="./View/Public/img/icon.png">
  </div>
...
<div id="msgInfoPage" style="display: none;" class="weui_msg">
  ...
  <div class="weui_opr_area">
    ...
    <p class="weui_btn_area">
      <button id="showMsgStateBtnInMsgInfoPage" class="weui_btn weui_btn_primary">查阅状态</button>
      <button id="blackBtnInMsgInfoPage" class="weui_btn weui_btn_primary">返回列表</button>
      <button onclick="showIndexPage()" class="weui_btn weui_btn_default">返回首页</button>
    </p>
  </div>
</div>
<div id="msgStatePage" style="display: none;" class="weui_msg">
  <div class="weui_text_area">
  </div>
  <div class="weui_opr_area">
